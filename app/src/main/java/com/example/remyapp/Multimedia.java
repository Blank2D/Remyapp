...
import com.example.remyapp.AccesoActivity;
import com.example.remyapp.R;
...
public class Multimedia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoPath = "android.resource://"+ getPackageName() + "/" + R.raw.tipcocina;
        ...
        String videoUrl = "https://www.youtube.com/embed/IUFj4mfOcjY";
